...
<html>
    ...
    <body>
        ...
        <form method="get" action="startgame.php">
            <div class="group">
                <input type="text" name="nome" id="nome"><span class="highlight"></span><span class="bar"></span>
            ...
            <button type="submit" class="button buttonBlue">Iniciar
                <div class="ripples buttonRipples"><span class="ripplesCircle"></span></div>
            </button>
        </form>
        <footer>
            <img src="inpihack-ativo.png">             
        </footer>
    </body)
